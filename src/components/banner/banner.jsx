    ...
    <>
        <div className=' mx-auto'>
          <div className='pt-10 ps-10 pr-10  pb-0'>
            ...
            <div className='ap-text-wrp relative'> <h1 className='text-center py-14 font-sans md:text-9xl text-2xl relative w-fit m-auto'>I'm <span >Abhinav</span><br/>Front-end Engineer <img className='absolute md:-left-36 -left-16  md:-bottom-20 -bottom-2' src={strock} alt="" /></h1></div>
